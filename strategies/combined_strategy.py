...
def run_combined_strategy(
    ...
    **kwargs
    ...
    if strategy_type == 'standard':
        cerebro.addstrategy(CombinedStrategy, **kwargs)
    elif strategy_type == 'aggressive':
        cerebro.addstrategy(AggressiveCombinedStrategy, **kwargs)
    elif strategy_type == 'conservative':
        cerebro.addstrategy(ConservativeCombinedStrategy, **kwargs)
...
if __name__ == '__main__':
    ...
    results1, _ = run_combined_strategy(df, strategy_type='standard')
    for key, value in results1.items():
        print(f"{key}: {value}")
    
    print("\n=== Aggressive Combined Strategy ===")
    results2, _ = run_combined_strategy(df, strategy_type='aggressive')
    for key, value in results2.items():
        print(f"{key}: {value}")
    
    print("\n=== Conservative Combined Strategy ===")
    results3, _ = run_combined_strategy(df, strategy_type='conservative')
